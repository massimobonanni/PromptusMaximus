...
{
    /// <summary>
    /// Completes a prompt using the specified AI model.
    /// </summary>
    ...
    Task<string> CompleteAsync(string modelName, string prompt, string ghToken, Languages language, CancellationToken cancellationToken);
}